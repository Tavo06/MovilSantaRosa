...
import com.upsjb.movilsantarosa.ui.feature.fines.components.FinesBottomNavigation
import com.upsjb.movilsantarosa.ui.feature.fines.components.FinesDescription
import com.upsjb.movilsantarosa.ui.feature.fines.components.FinesHeader

@Composable
fun FinesScreen(
    modifier: Modifier = Modifier
) {
    var selectedTab by remember { mutableStateOf(FineTab.FINES) }
...
@Preview(showBackground = true, name = "Fines Screen - Single Fine")
@Composable
fun PreviewFinesScreenSingleFine() {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(Color(0xFFF5F5F5))
